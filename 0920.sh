...
python feature_extract.py \
  ...
  --index_file_path oxford/0828_concat_imagenames.txt \
  --query_input_features_dir patchnetvlad/output_features/oxford_multiview/0519_concat \
  ...
  --index_file_path oxford/0828_front_imagenames.txt \
  --query_input_features_dir patchnetvlad/output_features/oxford_multiview/0519_front \
  --index_input_features_dir patchnetvlad/output_features/oxford_multiview/0828_front \
